...
class Actor(Network):
    def __init__(self, name, state_size, action_size, hidden_size):
        ...
        self.encoder = nn.ModuleList([
            LightweightResidualBlock(1, 32, stride=2),
            LightweightResidualBlock(32, 64, stride=2),
            LightweightResidualBlock(64, 128, stride=2)
        ])
        
        # Light FPN layers
        self.fpn = nn.ModuleList([
            LightFPNBlock(in_channels=128, out_channels=128, up_channels=128),
            LightFPNBlock(in_channels=64, out_channels=128, up_channels=128),
            LightFPNBlock(in_channels=32, out_channels=128, up_channels=128)
        ])
