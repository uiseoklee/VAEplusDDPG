...
class Actor(Network):
    def __init__(self, name, state_size, action_size, hidden_size):
        ...
        self.fc_mu = nn.Linear(256 * 1 * 1, 46)  # Extremely reduced input size
    ...
    def forward(self, states, visualize=False):
        ...
        encoded = self.encoder(li1_normalized)  # (batch_size, 256, 10, 20)
        encoded = self.flatten(encoded)         # (batch_size, 256*10*20)
