...
EPISODE_TIMEOUT_SECONDS     = 80 #100 #80 #50    # Number of seconds after which episode timeout occurs
...
THREHSOLD_GOAL              = 0.40 #0.20  # meters

OBSTACLE_RADIUS             = 0.16  # meters
MAX_NUMBER_OBSTACLES        = 4 #6
...
OBSERVE_STEPS   = 100 #25000     # At training start random actions are taken for N steps for better exploration
