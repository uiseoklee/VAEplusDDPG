...
![vaeplusddpg](media/vaeplusddpg_architecture_f.png)
...
![Comparison graph by method](media/graphs_methods_f.png)<br>
<br>
<img src="media/VAEplusDDPG_training_success.gif" width="400"/><br>

where other methods fail.<br>
